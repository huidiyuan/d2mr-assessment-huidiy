...
- Some extra white spaces in the car model column in messy dataset.
- Data types are different for many columns. 
- Some missing values in the cyl and hp columns.
- messy dataset has an extra column that is not in the original mtcars dataset.

2. What are the main issues you need to address in cleaning?

<!-- answer below -->
- Rename columns to match the original mtcars dataset.
- Change data types properly to match the original mtcars dataset. 
- Remove unwanted spaces in the car model column.
