...
Mini-project title: hello_world

Submission date: 2025/01/22

Project GitHub subdirectory URL: https://github.com/huidiyuan/d2mr-assessment-huidiy/tree/bb48512924865355f75fd437cc82a845f258159f/06_r-programming/01_hello-world
...
1: I used comments to explain the purpose of the code and the function of each part of the code.
2: I found and used documentations of many new functions, such as Sys.time(), if_else(), and str_to_title().
5: I followed the coding style guide and used consistent indentation and spacing throughout the code.
8: I used a for loop to calculate the days remaining until the school day. 
